...
<head>
    ...
    <title>SISTEMA - REPORTE DE PRODUCTIVIDAD DE FARMACIA</title>
...
$(document).ready(function(e) {
	//breadcrumb
	$('#breadc').html('<li><a href="index.php">FARMACIA</a></li><li class="active"><strong>REPORTE DE PRODUCTIVIDAD</strong></li>');
	...
	var oTableP = $('#dataTablePrincipal').DataTable({
		...
		"sAjaxSource": "farmacia/datatable-serverside/productividad_far.php",
