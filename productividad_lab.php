...
<head>
    ...
    <title>SISTEMA - REPORTE DE PRODUCTIVIDAD DE ESTUDIOS DE LABORATORIO</title>
...
$(document).ready(function(e) {
	//breadcrumb
	$('#breadc').html('<li><a href="index.php">LABORATORIO</a></li><li class="active"><strong>REPORTE DE PRODUCTIVIDAD</strong></li>');
	...
	var oTableP = $('#dataTablePrincipal').DataTable({
		...
		"sAjaxSource": "laboratorio/datatable-serverside/productividad_lab.php",
