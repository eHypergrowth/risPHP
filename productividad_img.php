...
<head>
    ...
    <title>SISTEMA - REPORTE DE PRODUCTIVIDAD DE ESTUDIOS DE IMAGEN</title>
...
$(document).ready(function(e) {
	//breadcrumb
	$('#breadc').html('<li><a href="index.php">IMAGEN</a></li><li class="active"><strong>REPORTE DE PRODUCTIVIDAD</strong></li>');
	...
	var oTableP = $('#dataTablePrincipal').DataTable({
		...
		"sAjaxSource": "imagen/datatable-serverside/productividad_img.php",
