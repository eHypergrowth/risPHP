...
<html lang="en"><head>
    ...
    <title>SISTEMA - ADMINISTRACIÓN - PAGOS POR USUARIO</title>
...
$(document).ready(function(e) {
	//breadcrumb
	$('#breadc').html('<li><a href="index.php">HOME</a></li><li>ADMINISTRACIÓN</li><li>CORTE DE CAJA</li><li class="active"><strong>PAGOS POR USUARIO</strong></li>');
	...
	var oTable = $('#dataTable').dataTable({
		...
		"aoColumnDefs": [ 
			...
			{"bVisible": true,"aTargets": [ 3 ] }, {"bVisible": true,"aTargets": [ 4 ] }, {"sClass":"right1","aTargets":[ 5 ] }, {"bVisible": true,"aTargets": [ 6 ] }
		],
		...
		"sAjaxSource": "corte_caja/reportes/datatable-serverside/reportes_pu_a.php",
